...
const NAV_SECTIONS = [
  { id: 'set1', label: 'Design Patterns' },
  { id: 'set2', label: 'When to Use' },
  { id: 'summary', label: 'Summary', divider: true },
]

export default function Lesson11() {
  return (
    <div style={styles.page}><NavSidebar sections={NAV_SECTIONS} /><LessonNav moduleTitle="Subagents" moduleColor={mod.color} prevLink="/subagents/mechanics" prevLabel="L10: Mechanics" nextLink="/interlude/3" nextLabel="Interlude 3" />
      <main style={styles.main}>
        ...
        <Reveal id="set1"><div style={{ ...styles.setLabel, color: C[1] }}>Set 1 — Design Patterns</div><h2 style={styles.h2}>Four characteristics of effective subagents</h2></Reveal>
        <Reveal>
          <img src={`${base}subagents-008.jpg`} alt="Four design patterns for effective subagents" style={styles.img} />
        </Reveal>
        ...
        <Reveal id="set2"><div style={{ ...styles.setLabel, color: C[2] }}>Set 2 — When to Use (and Avoid) Subagents</div><h2 style={styles.h2}>The decision framework</h2></Reveal>
        <Reveal>
          <img src={`${base}subagents-010.jpg`} alt="Decision framework for when to use subagents" style={styles.img} />
        </Reveal>
        ...
        <Reveal>
          <img src={`${base}subagents-012.jpg`} alt="Anti-patterns to avoid with subagents" style={styles.img} />
        </Reveal>
