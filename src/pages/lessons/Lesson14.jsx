...
export default function Lesson14() {
  return (
    <div style={styles.page}><NavSidebar sections={NAV_SECTIONS} /><LessonNav moduleTitle="GitHub Copilot" moduleColor={mod.color} prevLink="/copilot/customization" prevLabel="L13: Customization" nextLink="/claude-code/agent-loop" nextLabel="L15: Agent Loop" />
    ...
    },
    {
      ...
      "command": "node .github/hooks/lint-check.js"
        ...
        <Reveal id="summary"><div style={styles.endSection}><div style={styles.endLabel}>End of Lesson 14</div>
          ...
          <a href="/claude-code-anki/claude-code/agent-loop" style={styles.nextBtn}>Next → Lesson 15: The Agent Loop</a></div></Reveal>
      </main>
    </div>
  )
}
