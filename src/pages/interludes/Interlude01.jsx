...
const NAV_SECTIONS = [
  { id: 'tool-use', label: 'Tool Use Insight' },
  { id: 'context', label: 'Context as Resource' },
  ...
  return (
    <div style={styles.page}>
      ...
      <main style={styles.main}>
        ...
        <Reveal id="tool-use"><h2 style={styles.h2}>The Tool Use Insight</h2></Reveal>
        ...
        <Reveal id="context"><h2 style={styles.h2}>Context as a Finite Resource</h2></Reveal>
        ...
        <Reveal id="extensibility"><h2 style={styles.h2}>Extensibility as Architecture</h2></Reveal>
