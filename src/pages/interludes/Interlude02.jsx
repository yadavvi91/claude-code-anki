  ...
  return (
    <div style={styles.page}>
      ...
      <main style={styles.main}>
        ...
        <Reveal><h2 style={styles.h2}>The Three Primitives as a Design Language</h2></Reveal>
        ...
        <Reveal><h2 style={styles.h2}>The Burden Shift</h2></Reveal>
        ...
        <Reveal><h2 style={styles.h2}>Transport Matters More Than You Think</h2></Reveal>
        ...
        <Reveal><h2 style={styles.h2}>Sampling as Architecture</h2></Reveal>
