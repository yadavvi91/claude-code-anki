  ...
  return (
    <div style={styles.page}>
      ...
      <main style={styles.main}>
        ...
        <Reveal><h2 style={styles.h2}>The Five Extension Mechanisms</h2></Reveal>
        ...
        <Reveal><h2 style={styles.h2}>Context Window as the Central Constraint</h2></Reveal>
        ...
        <Reveal><h2 style={styles.h2}>The Fresh Perspective Principle</h2></Reveal>
        ...
        <Reveal><h2 style={styles.h2}>Anti-Patterns Worth Remembering</h2></Reveal>
        ...
        <Reveal><h2 style={styles.h2}>What Remains</h2></Reveal>
